const interrogationData = {
    ...
    responses: [
      {
        ...
        text: "「そうです。私が七瀬さんを殺害しました。高揚感からそのようなツイートをしてしまった。すぐに消したが、誰かが保存しているとは思わなかった。」"
      },
      {
        type: "FULL",
  ...
  "高梨 美穂": {
    ...
    responses: [
      {
        type: "FULL",
        required: ["camera_a-104", "sns_13"],
        text: "「確かに、私が1人でカラオケを出ているのはおかしいですよね…実は、宮本は3時前に帰りました。宮本に脅されてフェイク画像を作るように言われたんです。怖かった。」"
      },
      {
        type: "FULL",
        required: ["camera_a-404"],
        text: "「その画像がどうかしましたか？道が写っていますが。」"
      },
      {
        type: "FULL",
